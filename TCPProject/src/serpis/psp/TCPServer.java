...
public class TCPServer {
    ...
    private static void connectAndWrite() throws IOException {
    	...
    	printWriter.println("La hora es (primera vez) " + new Date());
    	printWriter.println("La hora es (segunda vez) " + new Date());
    	printWriter.println("La hora es (tercera vez) " + new Date());
